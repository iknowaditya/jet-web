...
function Footer() {
  return (
    <div class="max-w-screen- mx-12 p-5  sm:p-10 md:p-16 bg-neutral-300">
      <div class="mb-10 rounded overflow-hidden flex flex-col mx-auto text-center">
        <a
          href="/"
          class="max-w-3xl mx-auto text-xl sm:text-4xl font-semibold  hover:text-indigo-600 transition duration-500 ease-in-out inline-block mb-2"
        >
        ...
        <a href="/">
          <img
            class="w-full my-4"
            src="https://img.freepik.com/free-photo/airplane-flying-mountain-range-high-speed-generative-ai_188544-9182.jpg?t=st=1697635549~exp=1697639149~hmac=a6dfbc15fb1fe9d4c1f3c95f49d8b10f78f4f9fbcb61a448397f306e4514d645&w=1380"
